 ...
 *        src: vector of length N
 */
  __pyx_tuple__8 = PyTuple_Pack(14, __pyx_n_s_src, __pyx_n_s_pred_classes, __pyx_n_s_call_predictions_not_bat, __pyx_n_s_win_size, __pyx_n_s_file_duration, __pyx_n_s_src_cnt, __pyx_n_s_max_ind, __pyx_n_s_ii, __pyx_n_s_ee, __pyx_n_s_width, __pyx_n_s_pos, __pyx_n_s_pos_cnt, __pyx_n_s_val, __pyx_n_s_inds); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(5, 0, 14, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_nms_pyx, __pyx_n_s_nms_1d, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
